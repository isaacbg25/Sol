...
Amb els gràfics \ref{fig: orbita3met} ja podem notar que les diferències entre les òrbites càlculades pels diferents mètodes numèrics són realment mínimes, numèricament també s'observa el mateix.
